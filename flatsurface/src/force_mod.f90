...
! ========================================================
! Shear (MS) Force — Skalak model
! Analytical force on a single vertex from shear energy
...
! ========================================================
    ...
    & area_F_zero, Len_E_zero, Len_E, MS_Force_Point)
        ...
        do j=1,N_V_V(v_move)
            ...
            ! Find which edge is opposite to v_move
            k_c = 0
            do k=1,3
            ...
            ! Find the two edges adjacent to v_move and their opposite vertices
            i3=0
            k_a=0; k_b=0
            do k=1,3
