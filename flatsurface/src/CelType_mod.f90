module CelType_mod
  ...
  ! ###### Shear (MS) parameters — Skalak model
    integer HAS_REFERENCE   ! 1 if reference shape is set, 0 otherwise
    real*8 kpp_alpha         ! area dilation modulus
    real*8 mu_ms             ! shear modulus
    real*8 a3_ms, a4_ms      ! higher-order area dilation coefficients
    real*8 b1_ms, b2_ms      ! shear coupling coefficients
